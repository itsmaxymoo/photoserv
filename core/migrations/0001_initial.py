# Generated by Django 5.2.4 on 2025-09-13 14:11

import core.models
import django.db.models.deletion
import uuid
from django.db import migrations, models
from core import UI_THUMBNAIL_LARGE, UI_THUMBNAIL_SMALL
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='photo',
            name='tags',
            field=models.ManyToManyField(related_name='photos', through='core.PhotoTag', to='core.tag'),
        ),
        migrations.CreateModel(
            name='PhotoSize',
            fields=[
